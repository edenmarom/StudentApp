...
Model.instance().getAllStudents().get(studentPos);

TextView studentName =

findViewById(R.id.studentDetails_name_display);

TextView studentId =

findViewById(R.id.studentDetails_id_display);
TextView studentPhone =

findViewById(R.id.studentDetails_phone_display);
TextView studentAddress =

findViewById(R.id.studentDetails_address_display);
CheckBox studentCheckbox =
findViewById(R.id.studentDetails_check_dispaly);
